                ...
                <article className="overflow-hidden rounded-xl border border-white/10 bg-white/5 transition hover:border-indigo-400/40 hover:bg-white/[0.07]">
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-3 flex items-center justify-between text-sm">
                      ...
                      <span className="font-semibold text-indigo-300">Gig price for basic plan: ${gig.price.basic.price}</span>
                      <span className="font-semibold text-indigo-300">Gig price for standard plan: ${gig.price.standard.price}</span>
                      <span className="font-semibold text-indigo-300">Gig price for premium plan: ${gig.price.premium.price}</span>
                    </div>
