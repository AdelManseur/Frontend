...
export default function CreateGigPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    tags: [] as string[],
    price: {
      basic: { title: '', description: '', price: '', deliveryTime: '', revisions: '' },
      standard: { title: '', description: '', price: '', deliveryTime: '', revisions: '' },
      premium: { title: '', description: '', price: '', deliveryTime: '', revisions: '' }
    },
    images: [] as string[],
    ...
    try {
      ...
      const payload = {
        metadata: {
          ...
          deliveryTime: Number(formData.price.basic.deliveryTime) || 0,
                      ...
                      <div key={pkg} className="border border-neutral-200 rounded-[2rem] p-6 space-y-5 bg-neutral-50/50 hover:bg-white hover:border-neutral-300 transition-all">
                        ...
                        <div className="flex items-center gap-2 border-b border-neutral-200 py-2 focus-within:border-neutral-900">
                          <input
                            ...
                            value={formData.price[pkg].deliveryTime}
                            onChange={(e) => handlePackageChange(pkg, 'deliveryTime', e.target.value)}
